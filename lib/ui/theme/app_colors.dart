...
class AppColors {
  ...
  static const Color ikindi = Color(0xFFFF9800);
  static const Color aksam = Color(0xFFF44336);
  static const Color yatsi = Color(0xFF3F51B5);
  static const Color vitir = Color(0xFF009688);
